...
ActiveRecord::Schema.define(version: 20160914213413) do
  ...
  add_index "collaborations", ["collaborable_type", "collaborable_id"], name: "index_collaborations_on_collaborable_type_and_collaborable_id"
